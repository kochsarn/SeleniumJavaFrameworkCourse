...
public class InstantSauceTestNGTest01 {
    ...
    public void shouldOpenSafari() throws MalformedURLException {
         ...
         */
        String sauceUserName = "watchara";
        String sauceAccessKey = "586bd392-c07a-4f84-8499-cca6e7150b66";
        ...
        capabilities.setCapability("name", "01-best-practices");
        /**
