...
public class InstantSauceTestNGTest2 {
    ...
    public void shouldOpenSafari() throws MalformedURLException {
        ...
        String sauceUserName = System.getenv("watchara");
        String sauceAccessKey = System.getenv("59363426-673a-4b42-bb94-05ea4f688d23");
        String sauceURL = System.getenv("https://google.com");
